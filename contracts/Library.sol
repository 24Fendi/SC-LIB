...
contract Library {
    struct Book {
        address ISBN; // Tipe data ISBN diganti menjadi address
        string title;
        uint256 year;
        string author;
    }
    ...
    function addBook(
        address _ISBN, // Tipe data parameter _ISBN diganti menjadi address
    ...
    function removeBook(address _ISBN) public onlyAdmin {
        require(_ISBN != address(0), "ISBN cannot be empty");
    ...
    function getBookByISBN(address _ISBN)
        public
        view
